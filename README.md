...
This project defaults to scikit-learn's offline Digits dataset (8×8 images)
so it can run with no internet access. If you have internet access and want
to reproduce on full 28×28 MNIST instead:
...
(explained in REPORT.md) because this environment has no internet access to
download pretrained Inception-V3 weights. To compute standard, literature-
comparable FID/IS with internet access:
